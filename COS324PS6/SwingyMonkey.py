...
class SwingyMonkey:
  ...
  def __init__(self, sound=True, text=None, text2=None, text3=None, text4=None, action_callback=None,
  ...
  def game_loop(self):
    ...
    if self.text is not None:
      ...
      self.screen.blit(text, (self.screen_width-textpos[2]-120,0,textpos[2],textpos[3]))

    if self.text2 is not None:
      text2 = self.font.render(self.text2, 1, (230, 40, 40))
      self.screen.blit(text2, (self.screen_width-textpos[2]-120,30,textpos[2],textpos[3]))

    if self.text3 is not None:
      text3 = self.font.render(self.text3, 1, (230, 40, 40))
      self.screen.blit(text3, (self.screen_width - textpos[2] - 120, 60, textpos[2], textpos[3]))

    if self.text4 is not None:
      text4 = self.font.render(self.text4, 1, (230, 40, 40))
      self.screen.blit(text4, (self.screen_width - textpos[2] - 120, 90, textpos[2], textpos[3]))
